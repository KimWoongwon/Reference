...
/// <summary>
/// 벽의 종류를 결정하기 위한 binary 형식의 클래스
/// 좌표 상단을 기준으로 시계방향으로 돌면서 어떠한 물체가 있다면 1 없다면 0으로 표현
/// 코너의 경우 4방향 체크로 다 안되서 8방향 체크를 진행한다.
/// 벽의 모양을 정하기 위해선 여러종류의 조건이 있으니 이러한 조건들을 미리 셋팅해둔 클래스
/// </summary>
